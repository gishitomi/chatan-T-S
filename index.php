        ...
        <main>
            <div class="visual-box">
                ...
                <div class="mainvisual">
                    <img src="./assets/img/visual_1_pc.png" alt="" class="pc">
                    <img src="./assets/img/visual_1_sp.png" alt="" class="sp">
                </div>

                <img src="./assets/img/visual_text_pc.png" alt="" class="visual-text">
                <img src="./assets/img/visual_text_sp.png" alt="" class="sp-visual-text">
            </div>
